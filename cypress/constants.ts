...
export const INPUT_NUMBER = 'input[type="number"]';

export const CHANGING_STATE = 'rgb(210, 82, 225)';
export const MODIFIED_STATE = 'rgb(127, 224, 81)';
export const DEFAULT_STATE = 'rgb(0, 50, 255)';

export const CIRCLE_HEAD = 'div[class*="circle_head"]';
